    ...
    <div class="row">
        ...
        <div class="mb-1 col-md-4">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" wire:model.defer="has_projects" id="has_projects">
                <label class="form-check-label" for="has_projects">{{ __('dashboard.yes') }}</label>
            </div>
        </div>
        <div class="mb-1 col-md-4">
            <label class="form-check-label d-block mb-50">{{ __('dashboard.show_in_filter') }}</label>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" wire:model.defer="show_in_projects_filter" id="show_in_filter">
                <label class="form-check-label" for="show_in_filter">{{ __('dashboard.visible') }}</label>
            </div>
        </div>
        <div class="mb-1 col-md-4">
