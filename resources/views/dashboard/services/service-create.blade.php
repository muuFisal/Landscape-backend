<x-create-modal title="{{ __('dashboard.add-item') }}">
    <form class="form form-horizontal" wire:submit.prevent='submit'>
        <div class="row">
            ...
            <div class="mb-1 col-md-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" wire:model.defer="has_projects">
            ...
            <div class="mb-1 col-md-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" wire:model.defer="show_in_projects_filter">
                    <label class="form-check-label">{{ __('dashboard.visible') }}</label>
                </div>
            </div>
            <div class="mb-1 col-md-4">
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">{{ __('dashboard.close') }}</button>
        </div>
    </form>
</x-create-modal>
