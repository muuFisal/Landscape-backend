...
class AboutUpdate extends Component
{
    ...
    public $about_badge_ar, $about_badge_en, $about_title_ar, $about_title_en, $about_description_ar, $about_description_en, $about_image, $second_image, $home_image;
    ...
    protected function fillFromModel(): void
    {
        ...
        $this->home_image = $this->about->home_image;
    ...
    public function rules(): array
    {
        ...
        foreach (['about_image', 'second_image', 'home_image', 'mission_image', 'vision_image'] as $field) {
    ...
    public function submit(): void
    {
        ...
        $this->uploadAndReplace('home_image', 'home_image');
